...
FastAPI server that bridges between the Anki add-on and iOS app, providing semantic grading and concept Q&A using GPT-5.
...
2. GPT-5 semantic analysis for complex answers
